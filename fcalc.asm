...
section .data
	...
	f_div	db	"The float division by %f and %fi is %f",10,0
...
; print the result
        ...
        movsd   xmm0, [number1]
        movsd   xmm1, [number2]
        mov     rax,1 ; one floats
        call    printf
; squareroot
        sqrtsd  xmm1, [number1] ; double precision float into xmm
; print the result
        mov     rdi,f_sqrt
        movsd   xmm0, [number1]
        mov     rax,2 ; two floats
...
; exit
	mov 	rsp, rbp
	pop	rbp ; undo push at the beginning
	ret
